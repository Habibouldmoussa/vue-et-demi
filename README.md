...
> [!CAUTION] > `vue-demi` should not be used for new projects and will be deprecated in the future.
...
### Change node versions by folders

create .bash_profile or .bashrc in the user folder for changing the node versions
...
cdnvm(){
    ...
    if [[ ! $nvm_path = *[^[:space:]]* ]]; then
        ...
        default_version=$(nvm version 16);
